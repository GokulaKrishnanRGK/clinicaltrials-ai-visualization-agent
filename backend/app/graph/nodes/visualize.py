...
_AGG_TYPE_TO_VIZ: dict[str, VisualizationType] = {
    ...
    "by_phase_per_drug": VisualizationType.GROUPED_BAR_CHART,
...
_CHART_TITLES: dict[str, str] = {
    ...
    "by_phase_per_drug": "Trials by Phase per Drug",
...
_CHART_CONFIGS: dict[str, tuple[dict[str, str], EChartsRenderHints]] = {
    ...
    "by_phase_per_drug": (
        {"x": "phase", "y": "trial_count", "group": "drug_name"},
        EChartsRenderHints(
            x_axis_label="Phase",
            y_axis_label="Trials",
            category_field="phase",
            value_field="trial_count",
            group_field="drug_name",
            legend=True,
        ),
    ),
    "by_sponsor": (
